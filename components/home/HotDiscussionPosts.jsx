	...
	return (
		<section className="bg-emerald-50 py-6">
			<div className="max-w-3xl mx-auto ">
				...
				<div className="flex flex-col items-center mx-4 sm:mx-8 space-y-4 py-10">
					{discussions.map((discussion) => (
						<DiscussionCard key={discussion._id} discussion={discussion} />
					))}
				</div>
				<div className="w-fit mx-auto mt-4 px-6 py-1 xs:px-10 xs:py-2 bg-gray-700 text-lg xs:text-xl hover:bg-gray-500 hover:scale-105 hover:cursor-pointer transition-transform duration-300 text-white rounded-lg shadow-md">
