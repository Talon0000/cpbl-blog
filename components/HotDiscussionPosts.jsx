...
import findHotPosts from "@/app/actions/findHotPosts";
...
const HotDiscussionPosts = async () => {
	...
	//const discussionsDocs = await findHotPosts("discussion");
	const discussions = converToSerializableObject(discussionsDocs);

	return (
		<section className="bg-emerald-50 py-6">
			<div className="max-w-3xl mx-auto ">
				<h1 className="text-2xl tracking-wide text-gray-800 mb-4 md:text-4xl text-center font-semibold">
					熱門討論
				</h1>
				...
				<div className="w-fit mx-auto mt-4 px-10 py-2 bg-gray-700 text-xl hover:bg-gray-500 hover:scale-105 transition-transform duration-300 text-white rounded-lg shadow-md">
